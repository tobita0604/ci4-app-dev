...
<form action="<?php echo base_url();?>register_con/save_reserver" method="post" autocomplete="off" id="entry_data" > 
	...
	<h2 style ="background:#005084">EPC2022　参加受付　本人登録</h2>
...
-->
	...
	<table class="border2 invite" width="100%" id="invite0">
		...
		<tr>
			...
			<td>
				<input type="text" name="reserve[R01_Age]" value="<?=h($reserve['R01_Age'])?>" size="2" class="digits"/>　<span style="color:red;">※2025年3月29日基準</span><br>
