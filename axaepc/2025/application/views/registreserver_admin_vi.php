...
<form action="<?php echo base_url();?>mypage_admin_con/save_reserver" method="post" autocomplete="off" id="entry_data" > 
...
-->
	...
	<table class="border2 invite" width="100%" id="invite0">
		...
		<tr>
			...
			<td>
				<input type="text" name="reserve[R01_Age]" value="<?=h($reserve['R01_Age'])?>" size="2" class="digits"/>
		...
		<tr>
			...
			<td>
				<input type="text" name="reserve[R01_Emer_Name]" value="<?=h($reserve['R01_Emer_Name'])?>" />
		...
		<tr>
			...
			<td>
				<input type="text" name="reserve[R01_Emer_Relationship]" value="<?=h($reserve['R01_Emer_Relationship'])?>" />
...
&nbsp;&nbsp;&nbsp;
	<input type="image" src="<?php echo base_url();?>img/save.png" onclick="return validate_reserver(2);"/>
</div>
</div>
</section>