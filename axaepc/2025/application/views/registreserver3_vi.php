...
-->
	...
	<table class="border2 invite" width="100%" id="invite0">
		...
		<tr>
			...
			<td>
				<!--<input type="text" name="reserve[R01_Roma_Last]" id="R01_Roma_Last" value="<?=$reserve['R01_Roma_Last']?>" />-->
				<?=$reserve['R01_Roma_Last']?>
		...
		<tr>
			...
			<td>
				<!--<input type="text" name="reserve[R01_Roma_First]" id="R01_Roma_First" value="<?=$reserve['R01_Roma_First']?>" />-->
				<?=$reserve['R01_Roma_First']?>
		...
		<tr>
			...
			<td>
				...
				?>
				<input type="text" name="reserve[Birth_Year]" id="Birth_Year" value="<?=$Number_arr[0]?>" size="4" class="digits" onchange="age_changed()"/>年
				<input type="text" name="reserve[Birth_Month]" id="Birth_Month" value="<?=$Number_arr[1]?>" size="4" class="digits" onchange="age_changed()"/>月
				<input type="text" name="reserve[Birth_Day]" id="Birth_Day" value="<?=$Number_arr[2]?>" size="4" class="digits" onchange="age_changed()"/>日
		...
		<tr>
			...
			<td>
				<input type="text" name="reserve[R01_Age]" value="<?=$reserve['R01_Age']?>" size="2" class="digits"/>
		...
		<tr>
			...
			<td>
				<input type="text" name="reserve[R01_Address]" value="<?=$reserve['R01_Address']?>" size="35"/>
		...
		<tr>
			...
			<td>
				...
				?>
				<input type="text" name="reserve[Tel1]" value="<?=$Number_arr[0]?>" size="4"/> -
				<input type="text" name="reserve[Tel2]" value="<?=$Number_arr[1]?>" size="4"/> -
				<input type="text" name="reserve[Tel3]" value="<?=$Number_arr[2]?>" size="4"/>
		...
		<tr>
			...
			<td>
				...
				?>
				<input type="text" name="reserve[Mobile1]" value="<?=$Number_arr[0]?>" size="4"/> -
				<input type="text" name="reserve[Mobile2]" value="<?=$Number_arr[1]?>" size="4"/> -
				<input type="text" name="reserve[Mobile3]" value="<?=$Number_arr[2]?>" size="4"/>
		...
		<tr>
			...
			<td>
				<input type="text" name="reserve[R01_Email]" value="<?=$reserve['R01_Email']?>" size="35"/>
				<span class="error_msg" id="R01_Email_error"></span><br>
				<input type="text" name="reserve[R01_Email_cfm]" value="<?=$reserve['R01_Email']?>" size="35"/>（確認用）
		...
		<tr>
			...
			<td>
				...
				?>
				<input type="text" name="reserve[Emer1]" value="<?=$Number_arr[0]?>" size="4"/> -
				<input type="text" name="reserve[Emer2]" value="<?=$Number_arr[1]?>" size="4"/> -
				<input type="text" name="reserve[Emer3]" value="<?=$Number_arr[2]?>" size="4"/>
		...
		<tr class="bupload">
			...
			<td>
				<?php 
				if(!empty($reserve['R01_Passport_Img'])) {
					$color="#33BFDB";
					$value = "再アップロード";
				} else {
					$color="red";
				...
				<input type="button" id="R01_Brochure_Img_Btn" style="background:<?=$color;?>;" value="<?=$value;?>" onclick="savePhoto(<?=$reserve['R01_Id']?>, 0, '.bupload', 'passport');"></input>
		...
		<tr>
			<th class="">備考</th>
			<td>
				<textarea name="common[R01_Note]" style="width:100%" rows="5"><?=$common['R01_Note']?></textarea>
			</td>
		</tr>
	</table>
