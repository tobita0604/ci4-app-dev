...
<section id="about">
<div id="main">
<form action="<?php echo base_url();?>register_con/save_note" method="post" autocomplete="off" id="entry_data" > 
	<?php require(APPPATH . "views/element/csrf_input.php"); ?>
	<h2 style ="background:#005084">メモ編集</h2>
	...
	<div>
		<textarea rows=15 cols=120 name="R01_note"><?= isset($note['R01_note']) ? h($note['R01_note']) : ''; ?></textarea>
	</div>
