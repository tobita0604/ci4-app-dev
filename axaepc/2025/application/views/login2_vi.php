...
<div id="wrapper">
	<div class="login_wrapper">
		<form action="<?php echo base_url();?>login2_con/login" method="post">
		...
		<div class="login_form">
			<dl>
				<dt></dt>
				<dd class="error_msg">【特別登録】</dd>
				<dt></dt>
				<dd>ログインIDとパスワードを入力してください</dd>
				<!--<dd class="error_msg">システム調整のため、本日（2/19）12:00まで登録できません。</dd>-->
				<dt>ログインID</dt>
				<dd><input type="text" name="R00_Id" id="R00_Id" value="<?php if (isset($R00_Id)){echo $R00_Id;} ?>">
				</dd>
				...
				<?php }?>
				<dt>パスワード</dt>
				<dd><input type="password" name="R00_Password" id="R00_Password" value="" ></dd>
