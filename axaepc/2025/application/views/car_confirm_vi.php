...
<form action="" method="post" autocomplete="off" id="car_rental" > 
	<h2 style ="background:#005084">EPC2024　レンタカー確認</h2>
	...
	<?php else:?>
		<p>現在申し込みはありません。<br>申し込みをする場合は、以下の「申し込み」ボタンから入力をお願いします。</p>
	<?php endif;?>
</form>
...
?>
		&nbsp;&nbsp;&nbsp;
		<?php if(!empty($car_limit) && !empty($current_date)) :?>
		<?php if($car_limit >= $current_date) :?>
		<a href="<?php echo base_url(); ?>CarRental_con/edit" class="btn btn--orange">申し込み</a>
		<?php endif;?>
		<?php endif;?>
<?php
	}
