                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="dashboard-blog" class="nav-link"><span data-key="t-blog">Blog</span> <span
                        ...
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarCalendar">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-calendar" class="nav-link" data-key="t-main-calender"> Main
                                                Calender </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-calendar-month-grid" class="nav-link" data-key="t-month-grid">
                                                Month Grid </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarEcommerce">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-products" class="nav-link" data-key="t-products">
                                                Products </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-order-details" class="nav-link"
                                                data-key="t-order-details"> Order Details </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-customers" class="nav-link" data-key="t-customers">
                                                Customers </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-cart" class="nav-link" data-key="t-shopping-cart">
                                                Shopping Cart </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-checkout" class="nav-link" data-key="t-checkout">
                                                Checkout </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-seller-details" class="nav-link"
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarProjects">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-projects-overview" class="nav-link" data-key="t-overview">
                                                Overview </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-projects-create" class="nav-link" data-key="t-create-project">
                                                Create Project </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarTasks">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-tasks-details" class="nav-link" data-key="t-task-details">
                                                Task Details </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarCrypto">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-crypto-transactions" class="nav-link"
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-crypto-kyc" class="nav-link" data-key="t-kyc-application"> KYC
                                                Application </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarInvoices">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-invoices-create" class="nav-link" data-key="t-create-invoice">
                                                Create Invoice </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarTickets">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-tickets-details" class="nav-link" data-key="t-ticket-details">
                                                Ticket Details </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarnft">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-nft-marketplace" class="nav-link" data-key="t-marketplace">
                                                Marketplace </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-nft-explore" class="nav-link" data-key="t-explore-now">
                                                Explore Now </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-nft-auction" class="nav-link" data-key="t-live-auction"> Live
                                                Auction </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-nft-item-details" class="nav-link" data-key="t-item-details">
                                                Item Details </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-nft-collections" class="nav-link" data-key="t-collections">
                                                Collections </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-nft-creators" class="nav-link" data-key="t-creators"> Creators
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-nft-ranking" class="nav-link" data-key="t-ranking"> Ranking
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-nft-wallet" class="nav-link" data-key="t-wallet-connect">
                                                Wallet Connect </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-nft-create" class="nav-link" data-key="t-create-nft"> Create
                                                NFT </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                <a href="apps-file-manager" class="nav-link"> <span data-key="t-file-manager">File
                                        Manager</span></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarjobs">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-job-statistics" class="nav-link" data-key="t-statistics">
                                                Statistics </a>
                                        </li>
                                        <li class="nav-item">
                                            ...
                                            <div class="collapse menu-dropdown" id="sidebarJoblists">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <a href="apps-job-lists" class="nav-link" data-key="t-list">
                                                            List
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-job-application" class="nav-link" data-key="t-application">
                                                Application </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-job-categories" class="nav-link" data-key="t-job-categories">
                                                Job Categories</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarErrors">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="auth-offline" class="nav-link" data-key="t-offline-page"> Offline
                                                Page </a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarPages">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarProfile">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="pages-profile-settings" class="nav-link" data-key="t-settings">
                                                Settings </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                <a href="pages-search-results" class="nav-link" data-key="t-search-results"> Search
                                    Results </a>
                            </li>
                            <li class="nav-item">
                                <a href="pages-privacy-policy" class="nav-link" data-key="t-privacy-policy">Privacy
                                    Policy</a>
                            </li>
                            <li class="nav-item">
                                <a href="pages-term-conditions" class="nav-link" data-key="t-term-conditions">Term &
                                    Conditions</a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarBlogs">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="pages-blog-list" class="nav-link" data-key="t-list-view">List
                                                View</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="pages-blog-grid" class="nav-link" data-key="t-grid-view">Grid
                                                View</a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="ui-links" class="nav-link"><span data-key="t-links">Links</span> <span
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarApexcharts">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-candlestick" class="nav-link" data-key="t-candlstick">
                                                Candlstick </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-radialbar" class="nav-link" data-key="t-radialbar">
                                                Radialbar </a>
                                        </li>
                                        <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="icons-materialdesign" class="nav-link"><span
                            ...
                            <li class="nav-item">
                                <a href="icons-feather" class="nav-link"><span data-key="t-feather">Feather</span>
